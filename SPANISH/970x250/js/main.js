...
B.animate=function(){
  ...
  // global 'delay'
  var d=3,f=2;
  var flaretop={xstart:0,xend:500};
  var flareleft={ystart:200,yend:20};
  // flip 'flare' left and set 'flare top'
  TweenLite.set('#flare', {x:flaretop.xstart,y:14});
  TweenLite.set('#flare-copy', {rotation:-90,x:-51,y:flareleft.ystart,scaleX:0.85});
  // append cta btn div
